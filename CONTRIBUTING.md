...
3. Run `devtools::test()`.
4. Run `devtools::check()` and resolve all errors, warnings, and notes caused by
   the change.
5. Explain any change in empirical interpretation, especially changes involving
   shares, group movers, or entry and exit.
