...
中文用户请参阅[中文完整教程](vignettes/fhk-zh.Rmd)。An English
step-by-step guide is available in the [introductory
vignette](vignettes/fhk-introduction.Rmd).
...
`fhk_hierarchical()` to obtain both levels from correctly defined
weights:
